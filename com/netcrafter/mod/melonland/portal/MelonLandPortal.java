...
import com.netcrafter.mod.melonland.teleporter.MelonLandTeleporter;
...
public class MelonLandPortal extends BlockBreakable
{
    public static final int[][] field_150001_a = new int[][] {new int[0], {3, 1}, {2, 0}};

    public MelonLandPortal()
    {
        super("netcrafter:MelonLandPortal", Material.portal, false);
    ...
    {
        MelonLandPortal.Size size = new MelonLandPortal.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 1);
        MelonLandPortal.Size size1 = new MelonLandPortal.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 2);
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        MelonLandPortal.Size size = new MelonLandPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 1);
        MelonLandPortal.Size size1 = new MelonLandPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 2);
    ...
    public void onEntityCollidedWithBlock(World world, int par2, int par3, int par4, Entity entity)
    {
    	if((entity.ridingEntity == null) && (entity.riddenByEntity == null) && ((entity instanceof EntityPlayerMP))) {
    		...
    		}else if(player.dimension != LidlMelonRPG.dimid) {
    			player.timeUntilPortal = 10;
    			player.mcServer.getConfigurationManager().transferPlayerToDimension(player, LidlMelonRPG.dimid, new MelonLandTeleporter(mcserver.worldServerForDimension(LidlMelonRPG.dimid)));
    		}else{
    			player.timeUntilPortal = 10;
    			player.mcServer.getConfigurationManager().transferPlayerToDimension(player, 0, new MelonLandTeleporter(mcserver.worldServerForDimension(0)));
    		}
    	}
    }
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
    {
        ...
        for (int l = 0; l < 4; ++l)
        {
            ...
            p_149734_1_.spawnParticle("portalMelonLand", d0, d1, d2, d3, d4, d5);
        }
    }
    ...
    public static class Size
        {
            ...
            public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
            {
                ...
                this.field_150863_d = MelonLandPortal.field_150001_a[p_i45415_5_][0];
                this.field_150866_c = MelonLandPortal.field_150001_a[p_i45415_5_][1];
            ...
            protected int func_150853_a(int p_150853_1_, int p_150853_2_, int p_150853_3_, int p_150853_4_)
            {
                ...
                for (i1 = 0; i1 < 22; ++i1)
                {
                    ...
                    if (block1 != LidlMelonRPG.blockMelonShard)
                    {
                        break;
                    }
                }
                ...
                block = this.field_150867_a.getBlock(p_150853_1_ + j1 * i1, p_150853_2_, p_150853_3_ + k1 * i1);
                return block == LidlMelonRPG.blockMelonShard ? i1 : 0;
            }
            ...
            protected int func_150858_a()
            {
                ...
                for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
                {
                    ...
                    {
                        k = this.field_150861_f.posX + j * Direction.offsetX[MelonLandPortal.field_150001_a[this.field_150865_b][1]];
                        l = this.field_150861_f.posZ + j * Direction.offsetZ[MelonLandPortal.field_150001_a[this.field_150865_b][1]];
                        ...
                        if (block == LidlMelonRPG.portalMelonLand)
                        {
                            ++this.field_150864_e;
                        }
                        ...
                        if (j == 0)
                        {
                            block = this.field_150867_a.getBlock(k + Direction.offsetX[MelonLandPortal.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[MelonLandPortal.field_150001_a[this.field_150865_b][0]]);

                            if (block != LidlMelonRPG.blockMelonShard)
                            {
                                break label56;
                            }
                        }
                        ...
                        {
                            block = this.field_150867_a.getBlock(k + Direction.offsetX[MelonLandPortal.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[MelonLandPortal.field_150001_a[this.field_150865_b][1]]);
                ...
                {
                    j = this.field_150861_f.posX + i * Direction.offsetX[MelonLandPortal.field_150001_a[this.field_150865_b][1]];
                    k = this.field_150861_f.posY + this.field_150862_g;
                    l = this.field_150861_f.posZ + i * Direction.offsetZ[MelonLandPortal.field_150001_a[this.field_150865_b][1]];

                    if (this.field_150867_a.getBlock(j, k, l) != LidlMelonRPG.blockMelonShard)
                    {
            ...
            {
                return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == LidlMelonRPG.melonActivator || p_150857_1_ == LidlMelonRPG.portalMelonLand;
            }
            ...
            public void func_150859_c()
            {
                for (int i = 0; i < this.field_150868_h; ++i)
                {
                    ...
                    for (int l = 0; l < this.field_150862_g; ++l)
                    {
                        ...
                        this.field_150867_a.setBlock(j, i1, k, LidlMelonRPG.portalMelonLand, this.field_150865_b, 2);
                    }
                }
            }
        }
